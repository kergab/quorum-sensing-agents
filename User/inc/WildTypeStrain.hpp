#ifndef WildTypeStrain_HPP
#define WildTypeStrain_HPP
#include "Strain.hpp"
#include "Params.hpp"

class WildTypeStrain : public Strain {
public:
	...
	double bite_1;
	double loss_1;
	double rhli_sign_max;
	double lasi_sign_max;

	//state q2
	double bite_2;
	double loss_2;
	double rhli_sign_inter;
	double rhla_min;
	double rhlb_min;
	double rhlc_min;
	...
	void init(StrainDescriptor& strainDescriptor) {
		...
		v_treshold = strainDescriptor.variables[7].value.toDouble();
		critical_mass = strainDescriptor.variables[8].value.toDouble();
		
		bite_0 = strainDescriptor.states[0][0].value.toDouble();
		loss_0 = strainDescriptor.states[0][1].value.toDouble();
		rhli_sign_base = strainDescriptor.states[0][2].value.toDouble();
		lasi_sign_base = strainDescriptor.states[0][3].value.toDouble();
		rhla_base = strainDescriptor.states[0][4].value.toDouble();
		rhlb_base = strainDescriptor.states[0][5].value.toDouble();
		rhlc_base = strainDescriptor.states[0][6].value.toDouble();
		v_max_0 = strainDescriptor.states[0][7].value.toDouble();
		
		bite_1 = strainDescriptor.states[1][0].value.toDouble();
		loss_1 = strainDescriptor.states[1][1].value.toDouble();
		rhli_sign_max = strainDescriptor.states[1][2].value.toDouble();
		lasi_sign_max = strainDescriptor.states[1][3].value.toDouble();
		
		bite_2 = strainDescriptor.states[2][0].value.toDouble();
		loss_2 = strainDescriptor.states[2][1].value.toDouble();
		rhli_sign_inter = strainDescriptor.states[2][2].value.toDouble();
		...
		lasi_sign_inter = strainDescriptor.states[2][6].value.toDouble();
		v_max_1 = strainDescriptor.states[2][7].value.toDouble();
